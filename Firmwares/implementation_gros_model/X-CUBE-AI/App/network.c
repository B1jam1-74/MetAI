...
#define AI_NETWORK_MODEL_SIGNATURE     "0x8aae9a236176b6412c08922308950c98"
...
#define AI_TOOLS_DATE_TIME   "2026-04-20T16:12:20+0200"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_1030_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 10, 256, 1, 1), AI_STRIDE_INIT(4, 4, 40, 10240, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 256, 192, 1, 1), AI_STRIDE_INIT(4, 4, 1024, 196608, 196608),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 128, 96, 1, 1), AI_STRIDE_INIT(4, 4, 512, 49152, 49152),
...
/* Tensor #24 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_1030_output, AI_STATIC,
  24, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 1, 1), AI_STRIDE_INIT(4, 4, 4, 40, 40),
  1, &serving_default_keras_tensor_1030_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_1030_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 385204, 1, 1),
    385204, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1792, 1, 1),
    1792, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor_1030_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_6_output),
  &gemm_0_layer, 0x511058ca, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_1030_output_array.data = AI_PTR(g_network_activations_map[0] + 728);
    serving_default_keras_tensor_1030_output_array.data_start = AI_PTR(g_network_activations_map[0] + 728);
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 768);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 768);
    ...
    nl_3_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    nl_3_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
    ...
    nl_6_output_array.data = AI_PTR(g_network_activations_map[0] + 52);
    nl_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 52);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 11264);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 11264);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 207872);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 207872);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 208640);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 208640);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 306944);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 306944);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 307456);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 307456);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 356608);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 356608);
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 356992);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 356992);
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 381568);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 381568);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 381824);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 381824);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 385152);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 385152);
    return true;
  }
