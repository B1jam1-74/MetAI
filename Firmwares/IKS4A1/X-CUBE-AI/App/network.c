...
#define AI_NETWORK_MODEL_SIGNATURE     "0x8164c6eb39ba5e85935b5eda2362d2c8"
...
#define AI_TOOLS_DATE_TIME   "2026-05-29T21:53:04+0200"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 728);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 728);
