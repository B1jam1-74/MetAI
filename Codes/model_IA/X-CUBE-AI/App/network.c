...
#define AI_NETWORK_MODEL_SIGNATURE     "0x044e8f0aefb9c9dc7aab19bb346d26d2"
...
#define AI_TOOLS_DATE_TIME   "2026-04-18T16:09:02+0200"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 3, 64, 1, 1), AI_STRIDE_INIT(4, 4, 12, 768, 768),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 9476, 1, 1),
    9476, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_80_output_array.data = AI_PTR(g_network_activations_map[0] + 116);
    serving_default_keras_tensor_80_output_array.data_start = AI_PTR(g_network_activations_map[0] + 116);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 768);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 768);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 1024);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1024);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 9216);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 9216);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 9344);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 9344);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 9472);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 9472);
    return true;
  }
